    ...
    var app = new Vue({
        ...
        methods: {
            ...
            submitForm: function submitForm() {
                ...
                axios.post('/user/user-profile-pic', this.formData, { headers: { 'Content-Type': 'multipart/form-data' } }).then(function (response) {
            ...
            prepareToUpload: function prepareToUpload() {
...
if (document.querySelector('#article')) {
    var article = new Vue({
        ...
        methods: {
            ...
            fetchImages: function fetchImages(article_id, page) {
                var _this3 = this;

                this.loading = true;
                axios.get('/user/article_images/' + article_id + '?page=' + page).then(function (result) {
                    _this3.loading = false;
                    _this3.images = result.data.data.data;
                    _this3.pagination = result.data.pagination;
                    _this3.markerble = false;
                    console.log("works");
                }).catch(function (error) {
                    console.log(error);
                    _this3.loading = false;
            ...
            submitForm: function submitForm() {
                ...
                for (var i = 0; i < this.attachment.length; i++) {
                    var file = this.attachment[i];

                    this.formData.append('files[' + i + ']', file);
                }

                axios.post('/user_article/user-article-pic', this.formData, { headers: { 'Content-Type': 'multipart/form-data' } }).then(function (response) {
                    console.log(response);
                    _this4.fetchImages(_this4.article_id, _this4.pagination.current_page);
                }).catch(function (error) {
                    console.log(error);
                });
            },
            ...
            deleteFile: function deleteFile() {
                ...
                for (image in this.images.filter(function (image) {
                ...
                axios.post('/user/article/delete_images', { 'images': this.images.filter(function (image) {
                        return image.selected == true;
                    }), 'article_id': this.article_id }).then(function (response) {
                    _this5.fetchImages(_this5.article_id, _this5.pagination.current_page);
                    _this5.markerble = false;
                }).catch(function (error) {
            ...
            makeCover: function makeCover(id, page) {
                var _this6 = this;

                axios.get('/user/article/addorremovecover/' + id).then(function (response) {
                    _this6.loading = false;
                    _this6.fetchImages(_this6.article_id, page);
                }).catch(function (error) {
                    console.log(error);
                    _this6.loading = false;
                });
            },
            makeMarkerble: function makeMarkerble() {
                this.markerble = true;
            },
            mark: function mark(id, img_id) {
                ...
                console.log(this.images.filter(function (image) {
                    return image.selected == true;
                }));
            },
            prepareToUpload: function prepareToUpload() {
...
if (document.querySelector('#blogs')) {
    var blogs = new Vue({
        ...
        methods: {
            ...
            fetchblogs: function fetchblogs(page) {
                var _this8 = this;
                ...
                axios.get(this.url).then(function (result) {
                    ...
                    _this8.pagination = result.data.pagination;
                }).catch(function (error) {
                    console.log(error);
                });
            },
            ...
            inputFun: function inputFun(event) {
                var _this9 = this;
...
var render = function() {
  ...
  return _c("div", { staticClass: "search-bar-outer" }, [
    _c("div", { staticClass: "profile-bar" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-md-3 col-xs-6 col-sm-3" }, [
          _c("div", { staticClass: "gallery-thumb th-bg" }, [
            _c("figure", [
              _c("div", { attrs: { id: "pro_image" } }, [
                _vm.img == ""
                  ? _c("img", {
                      attrs: {
                        id: "pro_image_src",
                ...
                _vm._v(" "),
                _vm.public == 0
                  ? _c("figcaption", { attrs: { id: "pro_fig" } }, [
                      _c(
                        "a",
                        {
                          attrs: {
        ...
        _c(
          ...
          {
            staticClass:
              "col-md-6 col-md-offset-1 col-xs-6 col-sm-9 traveller-list"
          },
          [
            _c("div", { staticClass: "row" }, [
  ...
  function() {
    ...
    return _c("ul", [
      _c("li", [
        _c(
          "a",
          { staticClass: "social", attrs: { title: "Facebook", href: "#" } },
          [_c("i", { staticClass: "icon-facebook3" })]
        )
      ]),
      _vm._v(" "),
      _c("li", [
        _c(
          "a",
          { staticClass: "social", attrs: { title: "Twitter", href: "#" } },
          [_c("i", { staticClass: "icon-twitter3" })]
        )
      ]),
      _vm._v(" "),
      _c("li", [
        _c(
          ...
          {
            staticClass: "social",
            attrs: { title: "Google Bookmark", href: "#" }
          },
      ...
      _c("li", [
        _c("a", { staticClass: "social", attrs: { href: "#" } }, [
          _c("i", { staticClass: "icon-linkedin3" })
        ])
      ])
    ])
  }
