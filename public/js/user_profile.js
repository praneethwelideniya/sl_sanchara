...
var _mapValues = __webpack_require__(61);
...
var _placeInput = __webpack_require__(238);

var _placeInput2 = _interopRequireDefault(_placeInput);

var _autocomplete = __webpack_require__(241);
...
var _mountableMixin = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_google_maps__ = __webpack_require__(60);
...
var Googlemap = Vue.component('google-map', __WEBPACK_IMPORTED_MODULE_0_vue2_google_maps__["Map"]);
var Googlemarker = Vue.component('google-marker', __WEBPACK_IMPORTED_MODULE_0_vue2_google_maps__["Marker"]);
var TripMap = Vue.component('trip-map', __webpack_require__(247));
...
var MyComponent = Vue.component('my-profile', __webpack_require__(250));

var Comment = Vue.component('comment', __webpack_require__(253));
...
if (document.querySelector('#trip')) {
    Vue.component('gmapmap', __WEBPACK_IMPORTED_MODULE_0_vue2_google_maps__["Map"]);
    Vue.component('gmapmarker', __WEBPACK_IMPORTED_MODULE_0_vue2_google_maps__["Marker"]);
    var trip_activity = new Vue({
        el: '#trip',
        components: { TripMap: TripMap },
        data: {
        ...
        methods: {
            getPlaces: function getPlaces(index) {
                var _this10 = this;
                ...
                if (index == 0 && this.searchText[0].length > 3) {
                    ...
                    axios.get(this.place_url + '/' + this.searchText[0]).then(function (result) {

                        _this10.location_list.first = result.data;
                        _this10.optionShown.first = true;
                    }).catch(function (error) {
                        console.log(error);
                    });
                ...
                if (index == 1 && this.searchText[1].length > 3) {
                    ...
                    axios.get(this.place_url + '/' + this.searchText[1]).then(function (result) {

                        _this10.location_list.second = result.data;
                        _this10.optionShown.second = true;
                    }).catch(function (error) {
                        console.log(error);
                    });
                    this.type = this.$el.getAttribute('type');
            ...
            getMarkers: function getMarkers() {
                ...
                axios.get('/api/getTripLocations/' + this.asset_id).then(function (result) {
                    _this11.markers = result.data.stay;
                    _this11.travel_directions = result.data.travel;
                    console.log(_this11.markers);
                    console.log(_this11.travel_directions + "1 time");
                }).catch(function (error) {
                    console.log(error);
                });
            },
            ...
            prepareToDeleteActivity: function prepareToDeleteActivity(id) {
                this.type = 'activity';
                this.asset_id = id;
                this.showConfirm.deleteConfirm = true;
                this.modalActive.deleteConfirm = true;
            ...
            deleteAsset: function deleteAsset() {
                ...
                axios.post('/asset/delete' + '/' + this.type + '/' + this.asset_id).then(function (result) {
                    _this12.showConfirm.deleteConfirm = true;
                    _this12.modalActive.deleteConfirm = true;
                    if (_this12.type != 'activity') {
                        location.reload();
                    }
                }).catch(function (error) {
                    console.log(error);
            ...
            fetchtraveller: function fetchtraveller(page) {
                ...
                axios.get(this.url + '/' + '?page=' + page).then(function (result) {
                    _this13.travellers = result.data.data.data;
                    _this13.pagination = result.data.pagination;
                }).catch(function (error) {
                    console.log(error);
        ...
        watch: {
            travel_directions: function travel_directions(val) {
                var _this14 = this;

                this.$refs.map.$mapCreated.then(function () {
                    console.log('map created!');
                    var vm = _this14;
                    var map = _this14.$refs.map.$mapObject;
                    _this14.directionsService = new google.maps.DirectionsService();
                    _this14.travel_directions.forEach(function (value, key) {
    ...
    var deleteAsset = new Vue({
        ...
        methods: {
            ...
            deleteAsset: function deleteAsset() {
                ...
                axios.post('/asset/delete' + '/' + this.type + '/' + this.asset_id).then(function (result) {
                    _this15.showConfirm.deleteConfirm = true;
                    _this15.modalActive.deleteConfirm = true;
                    if (_this15.type != 'activity') {
                        location.reload();
                    }
                }).catch(function (error) {
                    console.log(error);
            ...
            fetchtraveller: function fetchtraveller(page) {
                ...
                axios.get(this.url + '/' + '?page=' + page).then(function (result) {
                    _this16.travellers = result.data.data.data;
                    _this16.pagination = result.data.pagination;
                }).catch(function (error) {
                    console.log(error);
    ...
    var comment = new Vue({
        ...
        methods: {
            getComments: function getComments() {
                ...
                axios.get('/get_comments/' + this.asset_id + '/' + this.asset_type).then(function (result) {
                    _this17.comments = result.data;
                }).catch(function (error) {
                    console.log(error);
                });
            },
            addComment: function addComment(req) {
                var _this18 = this;

                axios.post('/add_comment', req).then(function (response) {
                    _this18.getComments();
                    _this18.new_comment = '';
                }).catch(function (error) {
                    _this18.errors = error.response.data.errors();
                    _this18.showNotification('Something went wrong! Please try again later.', false);
                });
            },

            deleteComment: function deleteComment(val) {
                var _this19 = this;

                console.log('event emited');
                axios.post('/delete_comment', { 'id': val.id, 'asset_type': val.parent ? this.asset_type : 'comment' }).then(function (response) {
                    _this19.getComments();
                }).catch(function (error) {
                    _this19.errors = error.response.data.errors();
                    _this19.showNotification('Something went wrong! Please try again later.', false);
                });
            },
            editComment: function editComment(val) {
                var _this20 = this;

                axios.post('/update_comment', val).then(function (response) {
                    _this20.getComments();
                }).catch(function (error) {
                    _this20.errors = error.response.data.errors();
                    _this20.showNotification('Something went wrong! Please try again later.', false);
                });
            },
            ...
            setReply: function setReply(val) {
                this.addComment(val);
            }
        },
        watch: {
            new_comment: function new_comment(val) {
                if (val.length > 0) {
...
var update = __webpack_require__(85)("75fd7046", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../css-loader/dist/cjs.js!../../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-85ca06a4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../vue-loader/lib/selector.js?type=styles&index=0!./map.vue", function() {
     var newContent = require("!!../../../css-loader/dist/cjs.js!../../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-85ca06a4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../vue-loader/lib/selector.js?type=styles&index=0!./map.vue");
...
var _TwoWayBindingWrapper = __webpack_require__(86);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(85)("2362394a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../css-loader/dist/cjs.js!../../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ed35740a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../vue-loader/lib/selector.js?type=styles&index=0!./streetViewPanorama.vue", function() {
     var newContent = require("!!../../../css-loader/dist/cjs.js!../../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ed35740a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../vue-loader/lib/selector.js?type=styles&index=0!./streetViewPanorama.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var _pickBy = __webpack_require__(243);
...
Component.options.__file = "resources/js/components/TripMap.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21003e48", Component.options)
  } else {
    hotAPI.reload("data-v-21003e48", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-21003e48", module.exports)
  }
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        togleEditable: function togleEditable() {
            this.editable = !this.editable;
            this.edited_comment = this.comment.comment;
        }
    },
    watch: {
        new_reply: function new_reply(val) {
            if (val.length > 0) {
                this.but_dis = false;
            } else {
                this.but_dis = true;
        ...
        edited_comment: function edited_comment(val) {
            if (val.length > 0) {
                this.but_dis = false;
            } else {
                this.but_dis = true;
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "comment-holder gray-bg" }, [
    _c("figure", [
      _c("img", {
        attrs: { src: "/users/profile/" + _vm.comment.user_img, alt: "" }
      })
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "overflow-text" }, [
      _c("div", { staticClass: "comment-header" }, [
        _c("h4", { staticClass: "title font-20" }, [
          _vm._v(_vm._s(_vm.comment.user_name) + "\n                "),
          _vm.comment.auth && !_vm.editable
            ? _c(
                "i",
                {
        ...
        _c("div", { staticClass: "pull-right" }, [
          _c("time", { attrs: { datetime: "2018-02-27T04:59:01+00:00" } }, [
            _vm._v(_vm._s(_vm.comment.updated_at))
          ])
        ])
      ]),
      _vm._v(" "),
      _vm.editable && _vm.comment.auth
        ? _c("div", { staticClass: "reply-form" }, [
            _c("div", { staticClass: "row" }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.edited_comment,
                      expression: "edited_comment"
                    }
                  ],
                  staticClass: "form-control",
                  staticStyle: { height: "100px" },
                  attrs: { placeholder: "Comment" },
                  domProps: { value: _vm.edited_comment },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.edited_comment = $event.target.value
                    }
                  }
                })
              ]),
              ...
              _c("input", {
                staticClass: "btn",
                attrs: { disabled: _vm.but_dis === true, value: "Update" },
                on: {
                  click: function($event) {
                    $event.preventDefault()
                    _vm.editComment()
                        ...
                        directives: [
                          {
                            ...
                            rawName: "v-model",
                            value: _vm.new_reply,
                            expression: "new_reply"
                          }
                        ],
                        staticClass: "form-control",
                        staticStyle: { height: "100px" },
                        attrs: { placeholder: "Comment" },
                        domProps: { value: _vm.new_reply },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.new_reply = $event.target.value
                          }
                        }
                      })
                    ]),
      ...
      _vm._v(" "),
      _vm.comment.auth || _vm.comment.asset_user
        ? _c("div", { staticClass: "row" }, [
